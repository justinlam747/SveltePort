		...
		<div class="contact-content">
			...
			<div class="grid lg:grid-cols-2 gap-16">
				...
				<div class="space-y-8">
						...
						<div class="space-y-4">
							<div class="flex items-center space-x-4">
								...
								<div>
									...
									<p class="text-gray-600">{personalInfo.email || 'hello@abo.design'}</p>
								</div>
							</div>
					...
					<!-- Social Links -->
					<div>
						<h3 class="text-lg font-semibold text-gray-900 mb-4">Follow Me</h3>
						<div class="flex space-x-4">
							{#if personalInfo.social}
								{#each Object.entries(personalInfo.social) as [platform, url]}
									{#if url}
										<a href={url} target="_blank" rel="noopener noreferrer" 
											...
											<!-- Add appropriate icons for each platform -->
